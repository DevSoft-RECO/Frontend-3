  ...
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div class="bg-gradient-to-br from-blue-600 to-indigo-800 text-white p-6 rounded-2xl shadow-xl flex items-center justify-between">
        <div>
          <p class="text-xs font-black uppercase tracking-wider text-blue-200">Monto Colocado</p>
          ...
          <p class="text-xs text-blue-100 mt-1 font-medium">Generado por créditos y depósitos</p>
        </div>
        <span class="text-4xl opacity-80">💰</span>
      </div>
